    ...
    <div className='h-[60px] bg-gradient-to-r from-[#212122] via-[#27282b] to-[#2a2b2c] w-full'>
        <div className='flex justify-between px-10 items-center text-gray-300 h-full'>
            ...
            <div className='flex justify-center items-center gap-2 text-gray-300'>
                <button onClick={ saveImage } className='px-3 py-[6px] outline-none rounded-sm bg-[#212122] hover:bg-[#9553f8] font-medium'>Save</button>
                <button onClick={ downloadImage } className='px-3 py-[6px] outline-none rounded-sm bg-[#151516] hover:bg-[#9553f8] font-medium'>Dowload</button>
            </div>
        </div>
    </div>
  )
