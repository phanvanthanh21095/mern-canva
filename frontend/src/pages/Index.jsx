...
const Index = () => {
    ...
    return (
        <div className='bg-[#18191b] min-h-screen w-full'>
            <div className={`w-screen ${show ? 'visible opacity-100' : 'invisible opacity-30'} translate-all duration-500 h-screen fixed bg-[#252627ad] flex justify-center items-center`}>
                <div className='w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative'>
                    ...
                    {
                        type === 'singup' && <form action="">
                            <div className='flex flex-col gap-3 mb-3 text-white'>
                                <label htmlFor="name">Name</label>
                                <input type="text" name='name' id='name' placeholder='name' value={state.email} className='px-3 py-2 rounded-md border outline-none border-[#5c5c5e] focus:border-purple-500 bg-transparent' />
                            </div>
                            <div className='flex flex-col gap-3 mb-3 text-white'>
                                <label htmlFor="email">Email</label>
                                <input type="email" name='email' id='email' placeholder='email' value={state.email} className='px-3 py-2 rounded-md border outline-none border-[#5c5c5e] focus:border-purple-500 bg-transparent' />
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex gap-4'>
                            <button onClick={() => {
                                setType('signin');
                                setShow(true)
                            }} className='py-2 w-[80px] text-center bg-blue-500 text-white translate-all hover:bg-blue-600 rounded-[5px] font-medium'>Sign in</button>
                            <button onClick={() => {
                                setType('singup');
                                setShow(true)
                            }} className='py-2 w-[80px] text-center bg-purple-500 text-white translate-all hover:bg-purple-600 rounded-[5px] font-medium'>Sign up</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className='w-full h-full justify-center items-center p-4'>
                <div className='py-[168px] flex justify-center items-center flex-col gap-6'>
                    ...
                    <button onClick={() => {
                        setType('singup');
                        setShow(true)
                    }} className='py-2 w-[200px] text-center bg-purple-500 text-white translate-all hover:bg-purple-600 rounded-[5px] font-medium'>Sign for free</button>
                </div>
            </div>
        </div>
    )
