        ...
        <div className='bg-[#18191b] min-h-screen w-full'>
                ...
                <div className='w-[93%] m-auto py-3'>
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex gap-4'>
                            <button className='py-2 w-[80px] text-center bg-blue-500 text-white translate-all hover:bg-blue-600 rounded-[5px] font-medium'>Sign in</button>
                            <button className='py-2 w-[80px] text-center bg-purple-500 text-white translate-all hover:bg-purple-600 rounded-[5px] font-medium'>Sign up</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className='w-full h-full justify-center items-center p-4'>
                <div className='py-[168px] flex justify-center items-center flex-col gap-6'>
                    ...
                    <button className='py-2 w-[200px] text-center bg-purple-500 text-white translate-all hover:bg-purple-600 rounded-[5px] font-medium'>Sign for free</button>
                </div>
            </div>
        </div>
    )
